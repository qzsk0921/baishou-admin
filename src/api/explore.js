 ...
 */
export function getExploreNavbarList(data) {
    return request({
        url: '/system/system-discover/navbar/list',
        method: 'post',
        data,
        loading: 'tbody',
    })
 ...
 * 发现-导航栏-获取发现所有导航栏
 */
export function getExploreNavbarAll(target) {
    return request({
        url: '/system/system-discover/getAllNavbar',
        method: 'post',
 ...
 * @param {String} styleCode 导航栏样式编码(左对齐:left 居中:center)
 */
export function addExploreNavbar(data) {
    return request({
        url: '/system/system-discover/navbar/add',
        method: 'post',
        data
    })
}
 ...
 */
export function removeExploreNavbar(data, target) {
    return request({
 ...
 */
export function updateExploreNavbar(data) {
    return request({
 ...
 * @param {String} id //主键ID require 
 */
export function getOneExploreNavbar(id, target) {
    return request({
...
/**
 * 首页/发现-导航栏-获取导航下的所有条目(独立任务栏--获取导航下的所有条目-复用)
 * @param {*} data
 * @param {String} id //导航栏id require
 */
export function getExploreNavbarItems(id, target) {
    return request({
 ...
 * @param {Number} pageSize 每页记录数(默认10)
 */
export function getExploreNaventryList(data, target) {
    return request({
        url: '/system/system-discover/item/list',
        method: 'post',
        data,
        loading: target ? target : 'tbody',
    })
}
 ...
 */
export function addExploreNaventry(data) {
    return request({
        url: '/system/system-discover/item/add',
        method: 'post',
        data,
    })
}
 ...
 * @param {String} id //主键ID require 
 */
export function getOneExploreNaventry(id, target) {
    return request({
 ...
 * @param {String} isDefault //是否默认
 */
export function updateExploreNaventry(data) {
    return request({
 ...
 * @param {String} id //主键ID(如果多个逗号分割) require
 */
export function removeExploreNaventry(data, target) {
    return request({
 ...
 */
export function getExploreSectionList(data, target) {
    return request({
        url: '/system/system-discover/section/list',
        method: 'post',
        data,
        loading: target ? target : null
    })
 ...
 */
export function getOneExploreSection(id) {
    return request({
 ...
 * 
 */
export function addExploreSection(data, target) {
    return request({
        url: '/system/system-discover/section/add',
        method: 'post',
        data,
        loading: target ? target : null,
    })
 ...
 * @param {String} loadUrl 加载地址（动态情况使用） 
 */
export function updateExploreSection(data) {
    return request({
 ...
 */
export function removeExploreSection(data, target) {
    return request({
 ...
 * @param {Number} pageSize 每页记录数(默认10)
 */
export function getExploreCollectionList(data, target) {
    return request({
        url: '/system/system-discover/collection/list',
        method: 'post',
        data,
        loading: target ? target : null,
    })
 ...
 */
export function addExploreCollection(data, target) {
    return request({
        url: '/system/system-discover/collection/add',
        method: 'post',
        data,
 ...
 * @param {String} id //主键ID require 
 */
export function getOneExploreCollection(id, target) {
    return request({
 ...
 * @param {String} image image
 */
export function updateExploreCollection(data, target) {
    return request({
 ...
 * @param {String} id //主键ID(如果多个逗号分割) require
 */
export function removeExploreCollection(data, target) {
    return request({
...
/**
 * 独立任务栏/发现/首页 合辑详情-列表查询(跳转至表示查看更多的跳转)
 * @param {*} data
