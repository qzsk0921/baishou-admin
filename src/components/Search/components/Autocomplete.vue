  ...
  methods: {
    ...
    handleKeyEnter(e) {
      if (
        ...
        this.$emit('select', { 'value': e.target.value }, 'searchAll')
      }
    },
    select(item) {
      // this.$emit('input', item[this.valueKey])
      console.log(this.getInput().value)
      console.log(/^.+\s:\s$/g.test(this.getInput().value))
      if (/^.+\s:\s$/g.test(this.getInput().value)) {
        this.$emit('input', this.getInput().value + item[this.valueKey])
        this.$emit('select', item, 'searchByType')
      } else {
        this.$emit('input', item[this.valueKey] + ' : ')
