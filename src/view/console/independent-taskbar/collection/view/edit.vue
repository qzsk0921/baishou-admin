...
export default {
  ...
  methods: {
    ...
    // 创建
    handleCreate() {
      this.addExploreCollection()
    },
    // 修改
    handleEdit() {
      this.updateExploreCollection()
    },
    addExploreCollection() {
      addExploreCollection(this.formData, 'body').then(res => {
        this.toConsoleExploreCollectioin()
      })
    },
    updateExploreCollection() {
      updateExploreCollection(this.formData, 'body').then(res => {
        this.toConsoleExploreCollectioin()
      })
    },
    // 路由跳转
    ...
    getExploreNavbarItems(id) {
      getExploreNavbarItems(id).then(res => {
