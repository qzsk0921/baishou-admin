  ...
  <div class="container employee-container">
    ...
    <div class="table-container">
      <el-table :data="tableData" style="width: 100%" @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="interfaceId" label="所属界面模板分类"></el-table-column>
...
<script>
import Tab from '@/components/Tab/interface/interface'
...
export default {
  ...
  methods: {
    ...
    removeInterface(id) {
      removeInterface({ id }, '.main-container').then(res => {
        this.getInterfaceList()
      })
    },
    getOneInterface(id) {
