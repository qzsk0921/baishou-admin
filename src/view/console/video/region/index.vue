<template>
  <div class="container section-container">
    <el-button class="btn-create" type="primary" @click="handleCreate">创建地区</el-button>
...
<script>
import Tab from '@/components/Tab/video/region'
import Console from '@/components/console/console'
import Search from '@/components/Search'
import { getGegionList, getOneGegion, removeGegion } from '@/api/video'
...
export default {
  ...
  methods: {
    ...
    removeGegion(id) {
      removeGegion({ id }, '.main-container').then(res => {
        this.getGegionList()
      })
    },
    getOneGegion(id) {
